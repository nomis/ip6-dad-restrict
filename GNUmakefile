...
$(RELEASE_DIR)/: | $(BUILD_DIR)/
	rm -rf "$(RELEASE_DIR)/"
	mkdir $(RELEASE_DIR)/
	meson --buildtype=release $(RELEASE_DIR)/ -Db_lto=true $(MESON_OPTS) || (rm -rf "$(RELEASE_DIR)/"; false)
